...
public class Member {
    ...
    public void setOccupation(MemberOccupation occupation) { this.occupation =
            occupation; }
    public String getCollectivityId() { return collectivityId; }
    public void setCollectivityId(String collectivityId) { this.collectivityId =
            collectivityId; }
    ...
    public void setMembershipDate(LocalDate membershipDate) { this.membershipDate
            = membershipDate; }
    public List&lt;String&gt; getRefereesIds() { return refereesIds; }
    public void setRefereesIds(List&lt;String&gt; refereesIds) { this.refereesIds =
            refereesIds; }
